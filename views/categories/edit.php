                ...
                <form action="/categories/update" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name" required 
                               value="<?php echo isset($_SESSION['flash_old']['name']) ? htmlspecialchars($_SESSION['flash_old']['name']) : htmlspecialchars($category->name); ?>">
                    </div>
                        ...
                        <div class="input-group">
                            <span class="input-group-text">
                                <input type="color" id="colorPicker" 
                                    value="<?php echo isset($_SESSION['flash_old']['color']) ? htmlspecialchars($_SESSION['flash_old']['color']) : htmlspecialchars($category->color); ?>" 
                    ...
                    <div class="mb-3">
                        ...
                        <div class="p-3 border rounded d-flex align-items-center">
                            <div id="previewColor" style="width: 24px; height: 24px; border-radius: 50%; background-color: <?php echo isset($_SESSION['flash_old']['color']) ? htmlspecialchars($_SESSION['flash_old']['color']) : htmlspecialchars($category->color); ?>; margin-right: 10px;"></div>
                            <span id="previewName"><?php echo isset($_SESSION['flash_old']['name']) ? htmlspecialchars($_SESSION['flash_old']['name']) : htmlspecialchars($category->name); ?></span>
                        </div>
                    </div>
